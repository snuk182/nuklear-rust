...
pub type NkPlotValueGetter = ::std::option::Option<unsafe extern "C" fn(user: *mut ::std::os::raw::c_void,
                                                                          index: ::std::os::raw::c_int) -> f32>;
...
impl NkStyle {
    pub fn window(&mut self) -> NkStyleWindow {
        NkStyleWindow { internal: &mut unsafe { (*self.internal).window } }
    }
}
...
impl Default for NkCursorMap {
    fn default() -> Self {
        NkCursorMap { internal: [nk_cursor::default(); 7] }
    }
}
...
impl Default for NkCursor {
    fn default() -> Self {
        NkCursor { internal: nk_cursor::default() }
    }
}
...
impl NkContext {
    ...
    pub fn style(&mut self) -> NkStyle {
        NkStyle { internal: &mut self.internal.style }
    }
    ...
    pub fn style_load_cursor(&mut self, cur: NkStyleCursor, res: &NkCursor) {
        unsafe {
            nk_style_load_cursor(&mut self.internal as *mut nk_context,
                                 cur,
                                 &res.internal as *const nk_cursor);
        }
    }
    ...
    pub fn style_load_all_cursors(&mut self, table: &mut NkCursorMap) {
        unsafe {
            nk_style_load_all_cursors(&mut self.internal as *mut nk_context,
                                      &mut table.internal[0] as *mut nk_cursor);
        }
    }
